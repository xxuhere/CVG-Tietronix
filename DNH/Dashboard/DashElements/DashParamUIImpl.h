#pragma once
#include "DashParamConstantNames.h"
#include "../DashboardElementInst.h"

/// <summary>
/// Base class for a UI Implementation of an item in the dashboard.
/// </summary>
...
protected:
	DashParamUIImpl(DashboardElementInst* parentElement);
...
public:
	...
	/// <summary>
	/// The name of the UI implementation subclass.
	/// </summary>
