...
namespace CVG
{
	...
	public:
		...
		/// <summary>
		/// Get a const begin() iterator to Params, to allow things to 
		/// perform a ranged forloop on the ParamCache.
		/// </summary>
		/// <returns>The beginning const iterator.</returns>
		std::map<std::string, ParamSPtr>::const_iterator cbegin() const
		{
			return this->params.cbegin();
		}

		/// <summary>
		/// Get a const end() iterator to Params, to allow things to 
		/// perform a ranged forloop on the ParamCache.
		/// </summary>
		/// <returns>The ending const iterator.</returns>
		std::map<std::string, ParamSPtr>::const_iterator cend() const
		{
